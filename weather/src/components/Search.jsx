          ...
          <div className="row justify-content-center">
            <div className="col-md-4">
              <Card className="bg-light text-dark text-center card">
                <Card.Img
                  src={details.main.temp > 291 ? sunny : snowy}
                  alt="..."
                  className="bg-image"
                />
                <Card.ImgOverlay>
                  ...
                  <Row className="max-min">
                    <Col md={6}>
                      <ArrowUp className="mx-2 icons" />
                      {Math.floor(details.main.temp_max - 273.15)}ºC
                    </Col>
                    <Col md={6}>
                      <ArrowDown className="mx-2 icons" />
                      {Math.floor(details.main.temp_min - 273.15)}ºC
                    </Col>
                  </Row>
                  <Row className="wind-climate text-light mt-2">
                    <Col md={6}>
                      <CloudsFill className="mx-3 icons" />
                      {details.weather[0].description}
                    </Col>
                    <Col md={6}>
                      <Wind className="mx-3 icons" />
